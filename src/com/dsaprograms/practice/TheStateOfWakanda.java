...
/*
    The historic state of Wakanda has various monuments and souvenirs which are visited by many travelers every day. The guides follow a prescribed route
of visiting the monuments which improve them understand the relevance of each monument.
...
public class TheStateOfWakanda {
    public static void main(String[] args) {
        ...
        // We are going to print it column wise.
        for(int j=0;j<m;j++){
            if(j%2==0){ // Even column: print from top to bottom.
                for(int i=0;i<n;i++){
                    System.out.print(arr[i][j]+"->");
                }
            }
            else{// Odd column: print from bottom to top.
                for(int i=n-1;i>=0;i--){
                    System.out.print(arr[i][j]+"->");
                }
            }
